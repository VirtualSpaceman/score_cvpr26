#!/bin/bash
#SBATCH --job-name=domain_finetune          # A name for your job
#SBATCH --output=slurm_logs/dil-ft/%x_%A_%a.out    # Standard output log: jobname_jobID_taskID.out
#SBATCH --error=slurm_logs/dil-ft/%x_%A_%a.err     # Standard error log
