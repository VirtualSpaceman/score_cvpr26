#!/bin/bash
#SBATCH --job-name=merge_dil_ood           # A name for your job
#SBATCH --output=slurm_logs/dil-ood/%x_%A_%a.out    # Standard output log: jobname_jobID_taskID.out
#SBATCH --error=slurm_logs/dil-ood/%x_%A_%a.err     # Standard error log
...
# Example: 2 model(s) * 2 datasets * 8 merge_fns = 32 jobs
#SBATCH --array=1-32
...
# --- Other Parameters ---
merge_fns=("randmix" "pcb" "magmax" "tsv" "isoc" "ties" "saliency_svd" "avg")

# --- 2. Preparation ---
set -e
mkdir -p slurm_logs/dil-ood
