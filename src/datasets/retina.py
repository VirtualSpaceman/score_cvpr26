...
class _Retina:
    DOMAINS = ['aptos2019', 'DDR', 'idrid_retina', 'messidor2']
    CLASSES = ['No_Diabetic_Retinopathy', 
               'Mild_Diabetic_Retinopathy', 
               'Modetate_Diabetic_Retinopathy', 
               'Severe_Diabetic_Retinopathy',
