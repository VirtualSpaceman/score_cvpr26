...
from src.datasets.fedisic import FedISIC
from src.datasets.pacs import PACS
from src.datasets.officehome import OfficeHome
from src.datasets.retina import RetinaDomains
from src.datasets.nicopp import NICOpp
from src.datasets.terraincognita import TerraIncognita
